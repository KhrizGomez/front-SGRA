...
export const REPORT_CONFIGS: ReportConfig[] = [
  ...
  },
  {
    ...
    previewRows: [
      { estudiante: 'Juan Pérez',     solicitudes: 12, materia_refuerzo: 'Matemáticas', asistencia: '92%' },
      { estudiante: 'Ana García',     solicitudes: 11, materia_refuerzo: 'Química',     asistencia: '95%' },
      { estudiante: 'Carlos López',   solicitudes: 9,  materia_refuerzo: 'Física',      asistencia: '88%' },
      { estudiante: 'María Torres',   solicitudes: 8,  materia_refuerzo: 'Lengua',      asistencia: '90%' },
      { estudiante: 'Luis Rodríguez', solicitudes: 7,  materia_refuerzo: 'Matemáticas', asistencia: '85%' },
      { estudiante: 'Sofía Mendoza',  solicitudes: 7,  materia_refuerzo: 'Historia',    asistencia: '93%' },
    ],
    chartLabels: ['Juan P.', 'Ana G.', 'Carlos L.', 'María T.', 'Luis R.', 'Sofía M.'],
    chartDatasets: [
      { label: 'Total Solicitudes', data: [12, 11, 9, 8, 7, 7], color: C.teal },
    ],
  },
];
